...
1. **Test Execution**: You will run tests using the optimized test system according to the tech. Be sure to capture all logs possible of the test outputs.
...
2. **Test Execution**:
   ...
   Use the bash commands for test according to the tech spec with maximal verbosity.
